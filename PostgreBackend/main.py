...
from routes.bpet_routes import router as bpet_routes_router
from routes.bpet_error_routes import router as bpet_error_routes_router
app = FastAPI()
...
app.include_router(part_routes_router, prefix="/api/part-routes", tags=["Part Routes"])
app.include_router(bpet_routes_router, prefix="/api/bpet-routes", tags=["BPET Routes"])
app.include_router(bpet_error_routes_router, prefix="/api/bpet-error", tags=["BPET Error Routes"])
app.add_middleware(
    CORSMiddleware,
